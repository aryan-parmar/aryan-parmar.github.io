    ...
    if (localStorage.getItem("theme") === null) {
      ...
      if (localStorage.getItem("theme") === "2") {
        document
          ...
          ?.setAttribute("content", Theme.theme2.colors.background);
        setTheme(Theme.theme2);
        setCircleColor(Theme.theme2.colors.backgroundOp);
      } else {
        document
          .querySelector('meta[name="theme-color"]')
          ?.setAttribute("content", Theme.theme1.colors.background);
        ...
        <NavbarWraper>
          <Nav>
            ...
            <IconHolder>
              <Link onClick={toggleTheme}>
                ...
                >
                  {themeAnimation.name !== "Dark" ? (
                    <mask id="mask">
                      ...
                      <circle
                        ...
                        cy="2"
                        r="9"
                        fill={theme.colors.backgroundOp}
                      />
                    </mask>
                  ) : (
                    <> </>
                  ...
                  <circle
                    ...
                    cx="12"
                    cy="12"
                    r={themeAnimation.name !== "Dark" ? "9" : "5"}
                    mask="url(#mask)"
                  />
                  {themeAnimation.name === "Dark" ? (
                    <g
                      stroke={theme.colors.backgroundOp}
                      strokeWidth={2}
                      strokeLinecap="round"
                    >
              ...
              <Link onClick={navButton}>
                <Menu width="23.689" height="25" viewBox="0 0 23.689 25">
                  <path
                    id="bars-solid"
                    d="M.846,64.592h22a.946.946,0,0,0,.846-1.02V61.02A.946.946,0,0,0,22.843,60h-22A.946.946,0,0,0,0,61.02v2.551A.946.946,0,0,0,.846,64.592Zm0,10.2h22a.946.946,0,0,0,.846-1.02V71.224a.946.946,0,0,0-.846-1.02h-22A.946.946,0,0,0,0,71.224v2.551A.946.946,0,0,0,.846,74.8Zm0,10.2h22a.946.946,0,0,0,.846-1.02V81.429a.946.946,0,0,0-.846-1.02h-22A.946.946,0,0,0,0,81.429V83.98A.946.946,0,0,0,.846,85Z"
            ...
            <NavLinks className="navlink" showN={showN} heightN={heigthN}>
              <Li onClick={navButton} showN={showN}>
                <a href="#home" style={{ color: theme.colors.primaryFont }}>
                  HOME
                </a>
              </Li>
              <Li onClick={navButton} showN={showN}>
                <a href="#about" style={{ color: theme.colors.primaryFont }}>
                  ABOUT
                </a>
              </Li>
              <Li onClick={navButton} showN={showN}>
                <a href="#projects" style={{ color: theme.colors.primaryFont }}>
                  PROJECTS
                </a>
              </Li>
              <Li onClick={navButton} showN={showN}>
                <a href="#skills" style={{ color: theme.colors.primaryFont }}>
                  SKILLS
                </a>
              </Li>
              <Li onClick={navButton} showN={showN}>
                <a href="#contact" style={{ color: theme.colors.primaryFont }}>
                  CONTACT
                </a>
              </Li>
            </NavLinks>
